  ...
  return (
    <div className="mx-auto w-full max-w-full px-4 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-10 xl:max-w-[80rem]">
      ...
      {novidades.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-3xl border border-dashed border-gray-200 bg-white/50 py-12 text-center backdrop-blur-sm dark:border-gray-700 dark:bg-gray-800/50">
