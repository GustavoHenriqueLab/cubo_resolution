...
import { getCurrentProfile, getParcerias } from "@/lib/queries";
import { AdminParceriasClient } from "./admin-parcerias-client";
      ...
      <div className="mb-8 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Gerencie as parcerias firmadas com startups.
          </p>
        </div>
      </div>

      <AdminParceriasClient parcerias={parcerias} />
    </div>
  );
}
